...
export default function App() {
  ...
  // Đảm bảo luôn bật lại scroll khi chuyển route (Mạnh)
  useEffect(() => {
    // Nếu KHÔNG phải trang thêm nhân viên thì bật scroll
    if (pathname !== "/nhanvien/add" && !pathname.startsWith("/nhanvien/update")) {
      document.body.style.overflow = "auto";
    }
    // Nếu là trang add thì không can thiệp, để add.jsx tự xử lý
  }, [pathname]);
